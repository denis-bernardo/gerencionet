...
<div class="row">
    <div class="col-sm-12">
        <div class="actions">
            <a href="{{URL::route('admin.pedidos.create')}}" class="btn btn-success"><i class="fa fa-plus"></i> Adicionar pedido</a>
            <a href="{{URL::route('admin.pedidos.stats')}}" class="btn btn-primary"><i class="fa fa-line-chart"></i> Relatórios</a>
        </div>
    </div>
    <div class="col-sm-12">
        <div class="filters">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        <label>Status</label>
                        <select class="form-control filter-by" data-key="status">
                            <option value="1" {{Input::get('status') == 1 || is_null(Input::get('status')) ? 'selected' : ''}}>Aberto</option>
                            <option value="0" {{!is_null(Input::get('status')) && Input::get('status') == 0 ? 'selected' : ''}}>Finalizado</option>
                        </select>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        <label>Entrega</label>
                        <select class="form-control filter-by" data-key="entrega">
                            <option value="1" {{Input::get('entrega') == 1 || is_null(Input::get('entrega')) ? 'selected' : ''}}>Sim</option>
                            <option value="0" {{!is_null(Input::get('entrega')) && Input::get('entrega') == 0 ? 'selected' : ''}}>Não</option>
                        </select>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group form-group-no-label">
                        <a href="{{URL::route('admin.pedidos.index')}}" class="btn btn-default">Limpar filtros</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="input-group">
                                ...
                                {{Form::text('valor_recebido', null, ['class' => 'valor_recebido_order money form-control'])}}
                            </div>
                        </div>
                        <div class="form-group col-sm-6">
                            <label>Troco</label>
